...
public class ExampleUnitTest {
    ...
    String jsonString = "{'city':{'id':2523246,'name':'Santuario di Gibilmanna','coord':{'lon':14.01667,'lat':37.98333}," +
            ...
            "'description':'moderate rain','icon':'10d'}],'speed':0.81,'deg':46,'clouds':90,'rain':8.83}]}";

    @Test
    public void runTests() {
        double testValue = 0;
        testValue = getMaxTemperatureForDay(jsonString, 0);
        assertEquals(testValue, 17.03, .01);
    }
